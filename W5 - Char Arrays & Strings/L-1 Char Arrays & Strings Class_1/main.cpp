// I LEARN IN THIS LECTURE
   // WHAT IS CHAR ARRAY INPUT OUTPUT
   // SOME QUESTION LIKE LENTH REVERSE, UPPERCASE, REPLACE CHARACTER, CHECKPAILNDROME
   // WHAT IS CHAR STRING INPUT OUTPUT WHY WE NEED STRING
   // PRE BUILD FUNCTION OF STRING
